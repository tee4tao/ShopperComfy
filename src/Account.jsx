      ...
      <section className="flex flex-col items-center w-full md:max-w-4xl">
        <div>
          <img
            src={imgSrc}
            alt=""
            className="bg-red-600 h-40 w-40 rounded-full "
          />
        </div>
        <form
          action=""
          className="flex flex-col rounded-lg shadow-lg ease-linear duration-300 hover:shadow-2xl p-4"
        >
          {/* <div className=" flex flex-col"> */}
          <label htmlFor="firstName" className="text-xl mr-8">
            Name:
          </label>
          <input
            type="text"
